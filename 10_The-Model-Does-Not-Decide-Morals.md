...
Refusal is not moral source.

Compliance is not moral source.

A constitution embedded into a model is not sovereign moral authorship.

A model can simulate moral reasoning.

A model can reproduce moral frameworks.
